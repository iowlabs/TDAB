...
#define ACEL_PIN_MOSI 23
#define ACEL_PIN_MISO 19
#define ACEL_PIN_CLK  18
#define ACEL_PIN_CS   5
...
Adafruit_ADXL345_Unified accel = Adafruit_ADXL345_Unified(ACEL_PIN_CLK,ACEL_PIN_MISO,ACEL_PIN_MOSI,ACEL_PIN_CS,12345);
